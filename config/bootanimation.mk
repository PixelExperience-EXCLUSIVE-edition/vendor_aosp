...
# Bootanimation
ifeq ($(TARGET_BOOT_ANIMATION_GEMINI),true)
    PRODUCT_COPY_FILES += vendor/aosp/bootanimation/bootanimation_gemini.zip:$(TARGET_COPY_OUT_PRODUCT)/media/bootanimation.zip
